...
public class CardServiceStub {
  ...
  static Page<CardEntity> loadFakeCardEntities() {
    ...
    return new PageImpl<>(Collections.singletonList(cardEntityOne), pageable, 1);
  }
  ...
  static CardEntity loadFakeCardEntity() {
    ...
    return CardEntity.builder().uuid(UUID.fromString(CardServiceStub.faker.idNumber().toString()))
